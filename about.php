            ...
            <div class="row align-items-center">
              <div class="col-lg-6 col-md-6">
                <div class="section-title">
                  ...
                  <a href="admission.html" title="Admissions" class="btn-default">
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="section-title">
                ...
                <a href="contact.html" title="Contact Engineers &amp; Doctors School" class="btn-default">
                ...
                <div class="classes-col wow fadeInUp" data-wow-duration="1000ms">
                  <div class="class-thumb">
                    ...
                    <a href="#" title="Robotics Fair & Science Projects" class="crt-btn">
                      <img src="webImages/icon10.png" alt="" />
                    </a>
                  </div>
              ...
              <div class="col-lg-3">
                <div class="classes-col wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="200ms">
                  ...
                  <div class="class-info">
                    ...
                    <p>
                      Art events grow confidence, celebrate culture and creativity.
                    </p>
                  </div>
                </div>
                <!--classes-col end-->
              ...
              <div class="col-lg-3">
                <div class="classes-col wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">
                  ...
                  <div class="class-info">
                    ...
                    <p>
                      Sports activities build fitness, discipline, teamwork and resilience.
                    </p>
                  </div>
                </div>
                <!--classes-col end-->
              ...
              <div class="col-lg-3">
                <div class="classes-col wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
                  ...
                  <div class="class-info">
                    ...
                    <p>
                      Clubs and trips explore interests, friendships and experiences.
                    </p>
                  </div>
                </div>
                <!--classes-col end-->
              ...
              <div class="col-lg-3">
                <div class="classes-col">
                  ...
                  <div class="class-info">
                    ...
                    <p>
                      Science exhibitions showcase experiments, ideas and student innovation.
                    </p>
                  </div>
                </div>
                <!--classes-col end-->
              ...
              <div class="col-lg-3">
                <div class="classes-col">
                  ...
                  <div class="class-info">
                    ...
                    <p>
                      Stage shows develop expression, confidence and communication skills.
                    </p>
                  </div>
                </div>
                <!--classes-col end-->
              ...
              <div class="col-lg-3">
                <div class="classes-col">
                  ...
                  <div class="class-info">
                    ...
                    <p>
                      Inter-school games teach teamwork, discipline, respect and sportsmanship.
                    </p>
                  </div>
                </div>
                <!--classes-col end-->
              ...
              <div class="col-lg-3">
                <div class="classes-col">
                  ...
                  <div class="class-info">
                    ...
                    <p>
                      Educational tours connect classroom learning with real-world understanding.
                    </p>
                  </div>
                </div>
                <!--classes-col end-->
